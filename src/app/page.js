...
export default function Page() {
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
      <h1 style={{ fontSize: '1rem', fontWeight: 'bold', marginBottom: '2rem', marginTop: '2rem'}}>Analog Future</h1>
      <Home />
