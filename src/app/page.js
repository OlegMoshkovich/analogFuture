...
export default function Page() {
  ...
  return (
    <div style={{ width: '100dvw',  height: '100dvh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
      <h1 onClick={handleTitleClick} style={{ fontSize: '1rem', fontWeight: 'bold', marginBottom: '2rem', marginTop: '2rem', marginBottom: '1em', marginTop: '1em', cursor: 'pointer' }}>Analog Future</h1>
